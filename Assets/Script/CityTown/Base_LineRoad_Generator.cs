...
public class Base_LineRoad_Generator : MonoBehaviour
{
    public  string              Desc;
    ...
    public  Base_LineRoad_Generator road_Discord;   // 지워진 맵 마무리 하는 거
    ...
    virtual public  void    Work( Base_CityTownGenerator ctg )
    {
